...
``advance_panel`` is the frozen signature of ``docs/DATA_CONTRACT.md``
...
def scripted_contact_batch(
    ...
    *,
    ...
    (``docs/DATA_CONTRACT.md`` section 2 explicitly allows it).  It
    ...
    return ContactBatch(
        ...
        diagnostics={
            "source": "LABELLED_STUB reactive_seabed_mat.reactive_layer.panel.scripted_contact_batch",
            "replace_with": "reactive_seabed_mat.coastal_transport.build_contacts",
