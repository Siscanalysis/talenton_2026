...
Implements ``contracts/DATA_CONTRACT.md`` section 5.  The layout keeps the three
...
def ledger_to_dict(ledger: MassLedger) -> dict[str, Any]:
    return {
        ...
        "emitted_kg": ledger.emitted_kg,
        "boundary_in_kg": ledger.boundary_in_kg,
        "in_water_kg": ledger.in_water_kg,
        "in_active_mesh_kg": ledger.in_active_mesh_kg,
        "in_retrieved_media_kg": ledger.in_retrieved_media_kg,
